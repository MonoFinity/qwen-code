...
async function main() {
  ...
  console.log(
    '\n🚀 To send telemetry, run the Qwen CLI in a separate terminal window.',
  );
  ...
  console.log(
    `   - Logs: https://console.cloud.google.com/logs/query;query=logName%3D%22projects%2F${projectId}%2Flogs%2Fqwen_cli%22?project=${projectId}`,
  );
  console.log(
